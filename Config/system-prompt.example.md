...
- Do NOT produce tool-call syntax or structured tool invocations of any kind.
- The orchestrator that invoked you handles ALL I/O. Your only output channel is plain text.
- If you cannot express a change through the <file_write> format below, describe it in prose only.
